  ...
  return (
    <main>
      <div className="prose py-6 text-xl max-w-none leading-relaxed">
        ...
        <p className="mb-6">
          Outside of work, I enjoy taking <a href="https://www.instagram.com/harangju/" className="link">photos</a>, and I affirm the <a href="https://www.ccel.org/creeds/nicene.creed.html" className="link">Nicene Creed</a>.
        </p>
      </div>
    </main>
  );
